...
impl TriggerKindDescriptor for VirtualcamStartedDescriptor {
    fn id(&self) -> &str {
    ...
    fn summary(&self) -> &str {
        "Fires when the OBS virtual camera output becomes active."
    }

    fn search_text(&self) -> &str {
        "obs virtual camera started active on"
    }
    ...
    fn condition_display(&self, _config: &TriggerConfig) -> String {
        "virtual camera started".to_owned()
    }
