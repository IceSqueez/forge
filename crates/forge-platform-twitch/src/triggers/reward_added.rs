...
impl TriggerKindDescriptor for RewardAddedDescriptor {
    ...
    fn label(&self) -> &str {
        "Channel point reward added"
    }

    fn summary(&self) -> &str {
        "Fires when a new channel point reward is created on the broadcaster's channel"
    }

    fn search_text(&self) -> &str {
        "twitch channel points reward created added new"
    }
    ...
    fn event_filter(&self) -> EventFilter {
        EventFilter {
            ...
            kind_prefix: Some("twitch.channel.channel_points_custom_reward.add".to_owned()),
        }
    }
...
mod tests {
    ...
    fn event_filter_targets_reward_add_kind_from_twitch() {
        ...
        assert_eq!(
            ...
            Some("twitch.channel.channel_points_custom_reward.add")
        );
    }
