...
mod connection_auth_failed;
mod connection_connected;
mod connection_disconnected;
mod filter_created;
...
mod source_scene_item_created;
mod source_scene_item_lock_changed;
mod source_scene_item_removed;
...
pub use connection_auth_failed::ConnectionAuthFailedDescriptor;
pub use connection_connected::ConnectionConnectedDescriptor;
pub use connection_disconnected::ConnectionDisconnectedDescriptor;
...
pub use source_scene_item_created::SourceSceneItemCreatedDescriptor;
pub use source_scene_item_lock_changed::SourceSceneItemLockChangedDescriptor;
pub use source_scene_item_removed::SourceSceneItemRemovedDescriptor;
...
pub fn register_obs_triggers(reg: &mut TriggerRegistry) -> Result<(), RegistryError> {
    ...
    reg.register(Box::new(SourceSceneItemCreatedDescriptor))?;
    reg.register(Box::new(SourceSceneItemRemovedDescriptor))?;
