...
const KIND_ID: &str = "twitch.moderation.remove_moderator";
...
impl RemoveModeratorRunner {
    ...
    async fn apply(&self, target_login: &str) -> SubActionOutcome {
        ...
        let request = HelixRequest::new(HelixMethod::Delete, "/helix/moderation/moderators")
...
impl SubActionRunner for RemoveModeratorRunner {
    ...
    fn summary(&self) -> &str {
        "Revokes moderator status from a user in the channel."
    }

    fn search_text(&self) -> &str {
        "twitch moderation remove moderator revoke unmod role"
    }
