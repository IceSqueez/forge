...
tabler_icons! {
    ...
    Ban => "ban.svg",
    Replace => "replace.svg",
    DeviceGamepad2 => "device-gamepad-2.svg",
    Tags => "tags.svg",
    Bookmark => "bookmark.svg",
    ChartBar => "chart-bar.svg",
    CrystalBall => "crystal-ball.svg",
    Trophy => "trophy.svg",
    MessageOff => "message-off.svg",
    ClockHour4 => "clock-hour-4.svg",
    UserCheck => "user-check.svg",
    ClockPause => "clock-pause.svg",
    LockOpen => "lock-open.svg",
    Shield => "shield.svg",
    Sword => "sword.svg",
    FlagOff => "flag-off.svg",
    ToggleRight => "toggle-right.svg",
    Message2 => "message-2.svg",
    ...
    Browser => "browser.svg",
    Movie => "movie.svg",
    ArrowsShuffle => "arrows-shuffle.svg",
    Layout => "layout.svg",
    TransitionRight => "transition-right.svg",
    AspectRatio => "aspect-ratio.svg",
    Adjustments => "adjustments.svg",
    Filter => "filter.svg",
    PlayerTrackNext => "player-track-next.svg",
    CircleDot => "circle-dot.svg",
    DeviceTv => "device-tv.svg",
    PlayerRecord => "player-record.svg",
    DeviceFloppy => "device-floppy.svg",
    Camera => "camera.svg",
...
impl Icon {
    pub fn from_name(name: &str) -> Self {
        match name {
            ...
            "mood-tongue" => Icon::MoodTongue,
            "download" => Icon::Download,
            "plus" => Icon::Plus,
            "repeat" | "replay" => Icon::Repeat,
            "arrows-shuffle" => Icon::ArrowsShuffle,
            "eye" => Icon::Eye,
            ...
            "photo" | "file-image" | "image" | "file-photo" => Icon::Photo,
            "camera" => Icon::Camera,
            ...
            "device-gamepad-2" | "gamepad" => Icon::DeviceGamepad2,
            "tags" => Icon::Tags,
            "bookmark" | "marker" => Icon::Bookmark,
            "chart-bar" | "bar-chart" | "poll" => Icon::ChartBar,
            "crystal-ball" | "prediction" => Icon::CrystalBall,
            "trophy" => Icon::Trophy,
            "message-off" => Icon::MessageOff,
            "clock-hour-4" | "slow-mode" => Icon::ClockHour4,
            "user-check" => Icon::UserCheck,
            "clock-pause" | "timeout" => Icon::ClockPause,
            "shield" => Icon::Shield,
            "sword" => Icon::Sword,
            ...
            "layout" => Icon::Layout,
            "layout-2" => Icon::Layout2,
            "transition-right" => Icon::TransitionRight,
            "aspect-ratio" => Icon::AspectRatio,
            "adjustments" => Icon::Adjustments,
            "player-track-next" => Icon::PlayerTrackNext,
            "circle-dot" => Icon::CircleDot,
            "device-tv" => Icon::DeviceTv,
