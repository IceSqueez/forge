...
overlays_preview_browser_counts = Вкладка браузера з цією сторінкою рахується як підключена сторінка, тож тест доходить до неї так само, як до браузерного джерела OBS.
...
overlays_sound_issue_lookup_failed = forge не зміг прочитати обраний звук: { $reason }
