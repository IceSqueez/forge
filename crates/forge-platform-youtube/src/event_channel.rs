...
/// The platform's own outbound event origin: the live-chat poller and the
/// connection-state transitions publish here, and [`subscribe`](Self::subscribe)
/// hands the receiving half to the runtime. The platform never reaches into the
/// runtime.
