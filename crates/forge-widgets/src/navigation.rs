...
mod tests {
    ...
    #[test]
    fn sidebar_builds_empty() {
        let _: Element<'_, ()> = sidebar(
            &CATPPUCCIN_MOCHA,
            Sidebar {
                items: vec![],
                bottom_items: vec![],
    ...
    #[test]
    fn sidebar_leaf_inactive_builds() {
        let _: Element<'_, ()> = sidebar(
            &CATPPUCCIN_MOCHA,
            Sidebar {
    ...
    #[test]
    fn sidebar_group_collapsed_builds() {
        let _: Element<'_, ()> = sidebar(
            &CATPPUCCIN_MOCHA,
            Sidebar {
    ...
    #[test]
    fn sidebar_group_expanded_with_children_builds() {
        let _: Element<'_, ()> = sidebar(
            &CATPPUCCIN_MOCHA,
            Sidebar {
                items: vec![NavItem::Group {
    ...
    #[test]
    fn sidebar_active_child_builds() {
        let _: Element<'_, ()> = sidebar(
            &CATPPUCCIN_MOCHA,
            Sidebar {
                items: vec![NavItem::Group {
