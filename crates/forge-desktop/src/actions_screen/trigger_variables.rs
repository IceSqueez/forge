...
pub(crate) mod tests {
    ...
    use forge_types::{
        CanonicalCount, CanonicalVariable, PlatformId, TriggerConfig, VariableSchema, Variant,
        VariantKind,
    };

    use super::{DeclaredVariable, VariableStanding, declared_variables};
    ...
    impl StubTrigger {
        pub(crate) fn declaring(id: &'static str, variables: fn() -> TriggerVariables) -> Self {
            StubTrigger {
                id,
        ...
        assert_eq!(
            ...
            vec![
                ...
                (
                    ...
                    VariableStanding::Canonical(CanonicalVariable::Count(
